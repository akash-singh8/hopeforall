  ...
  return (
    ...
    <div className={styles.hope4all}>
        ...
        <div className={styles.descriptionContainer}>
           <p className={styles.hopedescribe}>We are Hope4All, a committed crowdfunding platform in India aiming to provide transparent and sustainable aid to underprivileged communities. We constantly strive to close the gap between aid givers and those in need by fostering resource allocation and collaboration.</p>
        </div>
    </div>
